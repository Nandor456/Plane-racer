...
namespace Szeminarium1_24_02_17_2
{
    internal static class Program
    {
        ...
        private static Vector4[] faceColors =
        {
            new Vector4(1.0f, 0.0f, 0.0f, 1.0f), // Top
            new Vector4(0.0f, 1.0f, 0.0f, 1.0f), // Front
            new Vector4(0.0f, 0.0f, 1.0f, 1.0f), // Left
            new Vector4(1.0f, 0.0f, 1.0f, 1.0f), // Bottom
            new Vector4(0.0f, 1.0f, 1.0f, 1.0f), // Back
            new Vector4(1.0f, 1.0f, 0.0f, 1.0f), // Right
        };
        ...
        {
            glCubeCentered = GlCube.CreateCubeWithFaceColors(Gl,
                ToFloatArray(faceColors[0]),
                ToFloatArray(faceColors[1]),
                ToFloatArray(faceColors[2]),
                ToFloatArray(faceColors[3]),
                ToFloatArray(faceColors[4]),
                ToFloatArray(faceColors[5]));

            glCubeRotating = GlCube.CreateCubeWithFaceColors(Gl,
                ToFloatArray(faceColors[0]),
                ToFloatArray(faceColors[1]),
                ToFloatArray(faceColors[2]),
                ToFloatArray(faceColors[3]),
        ...
        private static void RenderUI()
        {
            ...
            ImGui.Separator();
            ImGui.Text("Cube Face Color");
            string[] faces = { "Top", "Front", "Left", "Bottom", "Back", "Right" };
            ImGui.Combo("Select Face", ref SelectedFace, faces, faces.Length);
            ImGui.ColorEdit4("Face Color", ref faceColors[SelectedFace]);
